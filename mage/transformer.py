...
def transform(df, *args, **kwargs):
    ...
    fact_table = df.merge(pickup_location_dim, on=["pickup_longitude", "pickup_latitude"]) \
                ...
                [['VendorID', 'datetime_id', 'passenger_count_id', 'trip_distance_id', 'pickup_location_id', 'dropoff_location_id', 'rate_code_id', 'store_and_fwd_flag', 'fare_amount', 'extra', 'mta_tax', 'tip_amount', 'tolls_amount', 'improvement_surcharge', 'total_amount']]
